...
suite("Unit Tests", function () {
  suite("Basic Assertions", function () {
    ...
    // #2 checks for undefined
    test("#isDefined, #isUndefined", function () {
      assert.isDefined(null, "null is not undefined");
      assert.isUndefined(undefined, "undefined IS undefined");
      assert.isDefined("hello", "A string is not undefined");
    });
    // #3 checks falsey values
  ...
  suite("Equality", function () {
    ...
    // #7 check if objects and their children are equal using ==
  ...
  suite("Comparisons", function () {
    // #8 isAbove - checks if value is > ,
    // isAtMost - checks if value is <=
    ...
    // #9 isAtLeast - checks if value is >= ,
    //    isBelow - checks if value is <
  ...
  suite("Strings", function () {
    ...
    // #15 checks if value matches regex
  ...
  suite("Objects", function () {
    ...
    // #18 checks if value is an instance of
